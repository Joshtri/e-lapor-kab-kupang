  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6">
      ...
      <Breadcrumb className="mb-5">
        ...
        <Breadcrumb.Item>Detail OPD</Breadcrumb.Item>
      </Breadcrumb>
      ...
      <div className="mb-2 flex items-center justify-between">
        ...
        <Badge color="gray">{opd.reports?.length || 0} Laporan</Badge>
      </div>
        ...
        <div className="space-y-4">
          {opd.reports.map((report) => (
            <Card
              ...
              style={{
                borderLeftColor: `var(--flowbite-${getStatusColor(report.opdStatus)}-500)`,
              }}
            >

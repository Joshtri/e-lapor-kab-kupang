...
export const metadata = {
  title: 'Lapor KK Bupati | Kabupaten Kupang',
  description:
    'Sampaikan aspirasi, keluhan, dan laporan Anda langsung kepada Bupati Kabupaten Kupang melalui layanan Lapor KK Bupati. Cepat, mudah, dan transparan.',
  keywords: [
    'lapor bupati',
    'kabupaten kupang',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lapor KK Bupati - Kabupaten Kupang',
      },
    ],
  },
  twitter: {

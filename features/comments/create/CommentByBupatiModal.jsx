...
const CommentByBupatiModal = ({ open, setOpen, reportId }) => {
    ...
    <Modal show={open} onClose={() => setOpen(false)} size="xl">
      <Modal.Header className="border-b-4 border-blue-500">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-semibold">Komentar Pengaduan</span>
        </div>
      </Modal.Header>
...
export default CommentByBupatiModal;

CommentByBupatiModal.propTypes = {

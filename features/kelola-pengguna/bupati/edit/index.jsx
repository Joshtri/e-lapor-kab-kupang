...
const updateBupati = async ({ id, userData }) => {
...
export default function EditBupatiForm({ userId }) {
  ...
  // Update bupati mutation
  const updateBupatiMutation = useMutation({
    mutationFn: updateBupati,
    onSuccess: () => {
      toast.success('Akun Bupati berhasil diperbarui!');
      queryClient.invalidateQueries({ queryKey: ['users', 'BUPATI'] });
      queryClient.invalidateQueries({ queryKey: ['user', userId] });
      router.push('/adm/users/bupati');
    },
    onError: (error) => {
      toast.error(error.response?.data?.error || 'Gagal memperbarui bupati.');
    },
  });
  ...
  const onSubmit = async (data) => {
    ...
    updateBupatiMutation.mutate({ id: userId, userData: submitData });
  };
  ...
  if (isLoading) {
    return <LoadingScreen isLoading={true} message="Memuat data bupati..." />;
  }

  return (
    <>
      <LoadingScreen
        isLoading={updateBupatiMutation.isPending}
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        <div className="mb-6">
          <PageHeader
            title="Edit Akun Bupati"
            description="Perbarui informasi akun bupati"
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <TextInput
                ...
                disabled={updateBupatiMutation.isPending}
              />
            </div>
            ...
            <div className="flex justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <Button
                type="submit"
                color="blue"
                disabled={updateBupatiMutation.isPending || !isDirty}
              >
                {updateBupatiMutation.isPending ? (
                  <>

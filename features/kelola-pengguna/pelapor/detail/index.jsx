...
export default function PelaporDetail({ userId }) {
  ...
  if (isLoading) {
    return <LoadingScreen isLoading={true} message="Memuat detail pelapor..." />;
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-6">
        <PageHeader
          title="Detail Akun Pelapor"
          description="Informasi lengkap akun masyarakat (pelapor)"
      ...
      <Card>
        ...
        <div className="flex justify-between items-start mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
          ...
          <Button
            color="blue"
            onClick={() => router.push(`/adm/users/pelapor/${userId}/edit`)}
          >
        ...
        <div className="flex justify-end gap-3 mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
          <Button color="light" onClick={() => router.push('/adm/users/pelapor')}>

      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute top-0 bottom-0 left-12 w-1 bg-blue-500 dark:bg-blue-600"></div>
            <div className="text-center mb-8">
              <motion.div
                className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 mb-4"
              ...
              >
                <HiOutlineGlobe className="h-12 w-12" />
              </motion.div>
            ...
            {onlineSteps.map((step, index) => (
              <div key={index} id={step.id} className="relative pl-20 pb-8">
                <div className="absolute left-0 w-24 flex items-center justify-center">
                  <motion.div
                    className="z-10 w-10 h-10 rounded-full bg-blue-500 dark:bg-blue-600 flex items-center justify-center text-white"
                    animate={{ scale: [1, 1.2, 1] }}
                    transition={{
                      repeat: Infinity,
                      duration: 1.5,
                ...
                <div className="bg-white dark:bg-gray-700 rounded-lg p-5 shadow-md border border-gray-200 dark:border-gray-600">
                  <div className="flex items-center mb-3">
                    <step.icon className="h-6 w-6 text-blue-500 dark:text-blue-400 mr-2" />
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute top-0 bottom-0 left-12 w-1 bg-green-500 dark:bg-green-600"></div>
            <div className="text-center mb-8">
              <motion.div
                className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-yellow-200 dark:bg-blue-900 text-blue-600 dark:text-blue-300 mb-4"
                animate={{ scale: [1, 1.2, 1] }}
                transition={{
                  repeat: Infinity,
                  duration: 1.5,
              ...
              >
                <HiOfficeBuilding className="h-12 w-12 text-yellow-600 dark:text-yellow-300" />
              </motion.div>

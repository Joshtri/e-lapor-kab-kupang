...
import { HiOutlineArrowDown, HiOutlineMail, HiOutlineMailOpen, HiPaperAirplane } from "react-icons/hi"
        ...
        >
          ...
          >
            <Link href="/auth/register">
              <Button size="xl" gradientduotone="purpleToBlue" className="font-medium flex items-center gap-2">

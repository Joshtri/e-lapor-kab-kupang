      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <h3 className="text-4xl font-bold text-gray-900 mb-2 text-center dark:text-gray-200">{stats.reports}</h3>
            <p className="text-gray-600 text-center dark:text-gray-200">Total Laporan</p>
          ...
          <motion.div
            ...
            className="bg-white rounded-lg p-6 shadow-md border-t-4 border-green-500 dark:bg-slate-700"
          >
            ...
            <h3 className="text-4xl font-bold text-gray-900 mb-2 text-center dark:text-gray-200">{stats.resolved}</h3>
            <p className="text-gray-600 text-center dark:text-gray-200">Laporan Terselesaikan</p>
          ...
          <motion.div
            ...
            className="bg-white rounded-lg p-6 shadow-md border-t-4 border-yellow-500 dark:bg-slate-700"
          >
            ...
            <h3 className="text-4xl font-bold text-gray-900 mb-2 text-center dark:text-gray-200">{stats.inProgress}</h3>
            <p className="text-gray-600 text-center dark:text-gray-200">Dalam Proses</p>
          ...
          <motion.div
            ...
            className="bg-white rounded-lg p-6 shadow-md border-t-4 border-purple-500 dark:bg-slate-700"
          >
            ...
            <p className="text-gray-600 text-center dark:text-gray-200">Tingkat Kepuasan</p>

          ...
          <div className="flex items-center space-x-3 bg-green-50 dark:bg-green-900/20 px-3 py-2 rounded-lg border border-green-100 dark:border-green-800/30">
              ...
              label={
                <div className="relative">
                  <Avatar
                    ...
                    rounded
                    size="sm"
                    className="  dark:border-green-800 hover:scale-110 transition-all duration-300"
                  />
                  {unreadCount > 0 && (
            ...
            >
              ...
              <Dropdown.Item
                ...
                onClick={() => router.push('/bupati-portal/profile')}
              >
                Profile
              </Dropdown.Item>
              <Dropdown.Item
                icon={HiMailOpen}
                onClick={() => router.push('/bupati-portal/dashboard')}
              >
                Inbox
              </Dropdown.Item>
              <Dropdown.Divider />

...
import { HiOutlineEye, HiOutlineChatAlt2, HiOutlinePencilAlt } from "react-icons/hi";
      ...
      {reports.map((report) => (
        ...
        >
          ...
          <div className="flex gap-2 mt-4">
            <Button color="gray" size="sm" onClick={() => router.push(`/bupati-portal/laporan-warga/${report.id}`)}>

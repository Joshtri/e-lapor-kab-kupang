  ...
  return (
    <>
      ...
      <Modal show={openModal} onClose={() => setOpenModal(false)} size="xl">
          ...
          <div className="space-y-6">
            <div className="flex flex-col items-center">
              ...
              <ol className="relative border-l border-gray-200 dark:border-gray-700">
                <li className="mb-10 ml-6">
                  ...
                  <h3 className="mb-1 text-lg font-semibold text-gray-900">Registrasi Akun</h3>
                ...
                <li className="mb-10 ml-6">
                  ...
                  <h3 className="mb-1 text-lg font-semibold text-gray-900">Login</h3>
                  <p className="text-base font-normal text-gray-500">
                ...
                <li className="mb-10 ml-6">
                  ...
                  <h3 className="mb-1 text-lg font-semibold text-gray-900">Buat Pengaduan</h3>
                  <p className="text-base font-normal text-gray-500">
                ...
                <li className="mb-10 ml-6">
                  ...
                  <h3 className="mb-1 text-lg font-semibold text-gray-900">Verifikasi</h3>
                  <p className="text-base font-normal text-gray-500">
                ...
                <li className="ml-6">
                  ...
                  <h3 className="mb-1 text-lg font-semibold text-gray-900">Tindak Lanjut</h3>
                  <p className="text-base font-normal text-gray-500">
                    Pengaduan akan ditindaklanjuti dan Anda dapat memantau prosesnya
                  </p>
                </li>
              </ol>
            </div>
            ...
            <div className="mt-6 bg-gray-50 p-4 rounded-lg">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600">
                <li>Pastikan data yang diisi valid dan dapat dipertanggungjawabkan</li>
        ...
        <Modal.Footer>
          <Button gradientDuoTone="blueToGreen" onClick={() => setOpenModal(false)}>
            Saya Mengerti
          </Button>
        </Modal.Footer>
      </Modal>
